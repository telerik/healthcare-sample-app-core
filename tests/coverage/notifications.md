...
**Tests: 24 | File: notifications.test.ts**
...
| 8 | CRP elevated description | should show CRP elevated description for Critical Lab Alert | notifications.test.ts |
| 9 | Vitals Warning | should show Vitals Warning notification | notifications.test.ts |
| 10 | Blood pressure description | should show blood pressure description for Vitals Warning | notifications.test.ts |
...
| 17 | Description subtitles | should display notification description subtitles | notifications.test.ts |
...
| 24 | Mark all: badge hidden | should hide the notification badge after marking all read | notifications.test.ts |
